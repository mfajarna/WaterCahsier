<?php
    ...
    $carikode = mysqli_query($koneksi,"select max(kode_air) from tarif_air");
    $datakode = mysqli_fetch_array($carikode);
    if ($datakode) {
        $nilaikode = substr($datakode[0], 3);
        $kode = (int) $nilaikode;
        $kode = $kode + 1;
        $hasilkode = "TRF".str_pad($kode, 3, "0", STR_PAD_LEFT);
    } else {
        $hasilkode = "TRF001";
    }
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Tambah Data Tarif Air</h1>
        </div>
        </div>
        <br>
        <div class="container">
        <form action="#" method="post">
            ...
            <div class="form-group">
                <label>Kode</label>
                <input type="text" class="form-control" name="kode_air" id="kode_air" placeholder="kode_air" value="<?php echo $hasilkode; ?>" readonly>
            </div>
            <div class="form-group">
                <label>Nama Tarif</label>
                <input type="text" class="form-control" name="nama_tarif" id="nama_tarif" placeholder="Nama Tarif" required>
            </div>
            <div class="row">
            <div class="form-group col-md-6">
                <label>Volume Awal M<sup>3</sup></label>
                <input type="text" class="form-control" name="ukuran_awal" id="ukuran" placeholder="Ukuran Awal" required>
            </div>
            <div class="form-group col-md-6">
                <label>Volume Akhir M<sup>3</sup></label>
                <input type="text" class="form-control" name="ukuran_akhir" id="ukuran" placeholder="Ukuran Akhir">
            </div>
            </div>  
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" name="beban" id="beban" placeholder="Beban" required>
            </div>
