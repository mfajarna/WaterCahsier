<?php
    ...
    $id = $_GET['id']; 
    $data = mysqli_query($koneksi, "SELECT * FROM tarif_air WHERE id ='$id'");

    while($air = mysqli_fetch_array($data)){
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Update Data Tarif Air</h1>
        </div>
        </div>
        <br>
        <div class="container">
        <form action="updateAir.php" method="post">
       
            <div class="form">
            <div class="form-group">
            <input type="hidden" name="id" id="id" value="<?= $air["id"]; ?>" />
                <label>Kode</label>
                <input type="text" class="form-control" name="kode_air" id="kode_air" placeholder="kode_air" value="<?= $air["kode_air"]; ?>" readonly>
            </div>
            <div class="form-group">
                <label>Nama Tarif</label>
                <input type="text" class="form-control" name="nama_tarif" id="nama_tarif" placeholder="Nama Tarif" value="<?= $air["nama_tarif"]; ?>"  required>
            </div>
            <div class="row">
            <div class="form-group col-md-6">
                <label>Volume Awal M<sup>3</sup></label>
                <input type="text" class="form-control" name="ukuran_awal" id="ukuran_awal" placeholder="Ukuran Awal" value="<?= $air["ukuran_awal"]; ?>"  required>
            </div>
            <div class="form-group col-md-6">
                <label>Volume Akhir M<sup>3</sup></label>
                <input type="text" class="form-control" name="ukuran_akhir" id="ukuran_akhir" placeholder="Ukuran Akhir" value="<?= $air["ukuran_akhir"]; ?>" >
            </div>
            </div>  
            <div class="form-group">
                <label>Harga (Rp.)</label>
                <input type="number" class="form-control" name="harga" id="harga" placeholder="Harga" value="<?= $air["harga"]; ?>"  required>
            </div>
            <div class="form-group">
                <label>Beban (Rp.)</label>
                <input type="number" class="form-control" name="beban" id="beban" placeholder="Beban" value="<?= $air["beban"]; ?>"  required>
            </div>
